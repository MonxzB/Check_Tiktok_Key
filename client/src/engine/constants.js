// ============================================================
// engine/constants.js — YouTube Long-Form Key Finder constants
// ============================================================
...
// Keywords containing these get higher Search Intent score
export const SEARCH_INTENT_BOOST = [
...
// ── Topic Depth Signals ───────────────────────────────────────
export const TOPIC_DEPTH_SIGNALS = [
  '完全ガイド', '徹底解説', '入門', '基礎', '応用',
  '仕組み', 'なぜ', 'ステップ', '手順', '流れ',
  '初心者から上級者', 'ゼロから', '基本から', '一から',
];

// ── Risky Markers (lower LowRisk score) ──────────────────────
export const RISKY_MARKERS = [
...
// ── Evergreen Signals ────────────────────────────────────────
export const EVERGREEN_SIGNALS = [
  '方法', '使い方', 'やり方', '基礎', '入門',
  '解説', 'ガイド', '基本', 'コツ', '仕組み',
];

// ── Niche Heat (for Demand scoring) ──────────────────────────
export const NICHE_HEAT = {
  'AI / ChatGPT':    20,
  'Excel / Office':  17,
  'Lập trình':       15,
  'Công việc':       16,
...
// ── Expansion Data ────────────────────────────────────────────
export const LONG_FORM_SUFFIXES = [
